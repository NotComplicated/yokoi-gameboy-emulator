...
pub fn read_symbols(
    symbols_reader: Box<dyn system::SymbolRead>,
) -> Result<HashMap<(u16, u16), String>, SymbolError> {
    ...
    for line in reader.lines() {
        ...
        let name = fields.next().unwrap_or("n/a");
        symbol_map.insert((bank, addr), name.into());
    }
